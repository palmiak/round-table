...
const AUDIO = {
  SUCCESS: new Audio(new URL('/shared/audio/grunt-party.mp3', import.meta.url)),
  TWIST: new Audio(new URL('/shared/audio/vault-twist.mp3', import.meta.url)),
  SLAM: new Audio(new URL('/shared/audio/anvil.mp3', import.meta.url))
}
