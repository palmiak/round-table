...
const AUDIO = {
  PLUG: new Audio(new URL('/shared/audio/plug-in-piece.mp3', import.meta.url)),
  SAD: new Audio(new URL('/shared/audio/robot-sad.mp3', import.meta.url)),
  INTRO: new Audio(new URL('/shared/audio/robot-intro.mp3', import.meta.url)),
...
class Captcha {
  static defaults = {
    ...
    image: new URL('/shared/images/phil-moon.png', import.meta.url),
    pieces: 4,
